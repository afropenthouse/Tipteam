...
import { forgotPasswordDirect } from "@/lib/store";
...
export default function ForgotPassword() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await forgotPasswordDirect(form.email, form.password);
      ...
      <div className="hidden bg-gradient-hero p-12 lg:flex flex-col justify-center items-center text-white">
        <div className="max-w-md space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-white/80">Set a new password for your account directly</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold">Direct Reset</h3>
                <p className="text-white/70">No email verification needed - reset instantly</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-white/70">Start using your new password immediately</p>
              </div>
            </div>
          </div>
      ...
      <div className="flex items-center justify-center p-6 md:p-12">
        <form onSubmit={onSubmit} className="w-full max-w-sm space-y-5">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Enter your email and set a new password.</p>
          </div>
